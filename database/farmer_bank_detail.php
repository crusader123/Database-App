...
$query="SELECT f.Name,f.Bank_Account_No,v.Name FROM $table AS f,$table1 as v where v.Bank_Code=f.Bank_Code";
$result=paginate("farmer_bank_detail.php",$query,$mstart,$lim);
//$result=mysql_query($query,$con);
$result2 = mysql_query("SHOW FIELDS FROM $table",$con);
$num=mysql_numrows($result);
?>
<form action="admin.php" method="POST">
<table id="box-table-a" summary="Farmer Account Detail">
<thead><tr>
	...
	<th><font face="Arial, Helvetica, sans-serif">Bank_Name</font></th>
</tr>
</thead>
<tbody>
<?php
