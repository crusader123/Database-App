...
CREATE TABLE `BANK_GROUP` (
  ...
  PRIMARY KEY (`Name`),
  CONSTRAINT `BANK_GROUP_ibfk_1` FOREIGN KEY (`Name`) REFERENCES `BANK` (`Name`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `BANK_GROUP` VALUES ('INDIAN BANK','551'),('kapil1','450'),('Kenara','54'),('P.N.B','53'),('S.B.I','52'),('UCO BANK','57');
...
-- Dump completed on 2012-10-30 23:50:17
