...
$query="SELECT f.Name,f.Father_Name,v.Name FROM $table AS f,$table1 as v where v.Village_Code=f.Village_Code";
$result=paginate("farmer_detail.php",$query,$mstart,$lim);
...
<thead>
<tr>
	<th >Farmer_Name</font></th>
	<th >Father_Name</font></th>
	<th >Village</font></th>
</tr>
</thead>
<tbody>
